...
exports.sendEmergencyNotification = functions.firestore.document('emergencyNotifications/{notificationId}')
    .onCreate(async (snap, context) => {
        const message = {
            notification: {
                title: 'Emergencia',
                body: 'El usuario ha presionado el botón de emergencia.',
            },
            topic: 'emergency',
        };
